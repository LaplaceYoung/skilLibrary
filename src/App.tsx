...
const PromoShell = lazy(() => import('./pages/promo/PromoShell').then((module) => ({ default: module.PromoShell })));
const PromoOverview = lazy(() => import('./pages/promo/PromoOverview').then((module) => ({ default: module.PromoOverview })));
const PromoGrowth = lazy(() => import('./pages/promo/PromoGrowth').then((module) => ({ default: module.PromoGrowth })));
const PromoBenchmarks = lazy(() =>
  import('./pages/promo/PromoBenchmarks').then((module) => ({ default: module.PromoBenchmarks })),
);
